...
//    RNLBeaconParser *ibeaconParser = [[RNLBeaconParser alloc] init];
//    [ibeaconParser setBeaconLayout:@"m:2-3=0118,i:4-19,i:20-21,i:22-23,p:24-24" error: Nil];
//    RNLBeaconParser *ibeaconParser1 = [[RNLBeaconParser alloc] init];
//    [ibeaconParser setBeaconLayout:@"m:0-3=4c000215,i:4-19,i:20-21,i:22-23,p:24-24" error: Nil];
    
//ibeacon layout m:0-3=4c000215,i:4-19,i:20-21,i:22-23,p:24-24
    
    self.beaconParsers = @[ altBeaconParser, uidBeaconParser, urlBeaconParser, eidBeaconParser, tlmBeaconParser];//,ibeaconParser,ibeaconParser1];
